      ...
      <section className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            {isLoggedIn ? (
              <Link to="/create-blog" className="bg-white hover:bg-gray-100 text-indigo-600 font-semibold py-3 px-6 rounded-lg inline-block transition duration-300">Write a Blog</Link>
            ) : (
              <Link to="/sign-up" className="bg-white hover:bg-gray-100 text-indigo-600 font-semibold py-3 px-6 rounded-lg inline-block transition duration-300">Get Started</Link>
            )}
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link to="/blogs/category/development" className="category-card bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-8 rounded-xl text-center transition-transform duration-300">
              <h3 className="text-xl font-bold mb-3">Development</h3>
              <p className="text-indigo-100">JavaScript, React, Node.js and more</p>
            </Link>
            <Link to="/blogs/category/database" className="category-card bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-8 rounded-xl text-center transition-transform duration-300">
              <h3 className="text-xl font-bold mb-3">Database</h3>
              <p className="text-indigo-100">MongoDB, SQL, and data modeling</p>
            </Link>
            <Link to="/blogs/category/design" className="category-card bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-8 rounded-xl text-center transition-transform duration-300">
              <h3 className="text-xl font-bold mb-3">Design</h3>
              <p className="text-indigo-100">UI/UX, CSS, and responsive design</p>
            </Link>
            <Link to="/blogs/category/devops" className="category-card bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-8 rounded-xl text-center transition-transform duration-300">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            {isLoggedIn ? (
              ...
              <Link to="/sign-up" className="bg-white hover:bg-gray-100 text-indigo-600 font-semibold py-3 px-8 rounded-lg inline-block transition duration-300">Create an Account</Link>
            )}
          </div>
        </div>
      </section>
